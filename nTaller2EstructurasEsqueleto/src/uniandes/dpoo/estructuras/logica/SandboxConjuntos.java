...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
        ...
        for(String cadenaActual : arbolCadenas.descendingSet())
        {
            listaInvertida.add(cadenaActual);
        }
    ...
    {
        String primeraCadena = getPrimera();
    ...
    {
        NavigableSet<String> actualizado = new TreeSet<String>();

        for(String cadenaActual : arbolCadenas)
        {
            actualizado.add(cadenaActual.toUpperCase());
        }

        arbolCadenas = actualizado;
    }
    ...
    {
        TreeSet<String> arbolInvertido =
                new TreeSet<String>(arbolCadenas.descendingSet());
